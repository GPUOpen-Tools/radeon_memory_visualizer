...
/// \file
/// \brief  Implementation for RMV Geometry settings.   Leverages Qt's
/// saveGeometry/restoreGeometry methods to persist a widget's position, size and state.
/// The data is saved in the RMV settings file as a hex string.
//=============================================================================
